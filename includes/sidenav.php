<!-- OFFCANVAS -->
<nav class="navbar navbar-light" style="background-color: #878383!important ;">
            <div class="container-fluid">
                <a class="navbar-brand" href="../index.php" style="color: white;">CultureDev.to™</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
                    <span class="navbar-toggler-icon"></span>
                </button>
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" >
                    <div class="offcanvas-header" style="background-color: #878383;">
                        <h5 class="offcanvas-title" id="offcanvasNavbarLabel" style="color: white;">SideNav</h5>
                    ...
                    <div class="offcanvas-body" >
                        <ul class="navbar-nav ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($title == "Categories")? "active" : "" ?>" href="categories.php">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($title == "Posts")? "active" : "" ?>" href="posts.php">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($title == "Users")? "active" : "" ?>" href="#">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?= ($title == "Profile")? "active" : "" ?>" href="profile.php">
